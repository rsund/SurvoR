...
static void init_words() {
    ...
    bt[5] = "\375i";
    at[6] = "del";
    bt[6] = "\375v"; /* viitataan indeksiin 6 */
    at[7] = "ins line";
    bt[7] = "\375I";
    at[8] = "del line";
    bt[8] = "\375V";
    ...
    bt[42] = " ";
    at[43] = "save char";
    bt[43] = "\375Gx"; /* =stack char */
    at[44] = "save word";
    bt[44] = "\375Gw"; /* =stack word */
    at[45] = "save cursor";
    bt[45] = "\375GR";
    at[46] = "stack cursor";
    bt[46] = "\375GR";
    ...
    at[49] = "save datapath";
    bt[49] = "\375Gd";
    at[50] = "stack datapath";
    bt[50] = "\375Gd";
    at[51] = "save systemdisk";
    bt[51] = "\375Gg";
    at[52] = "stack systemdisk";
    bt[52] = "\375Gg";
    at[53] = "save corner";
    bt[53] = "\375GL3\375GL4";
    at[54] = "stack corner";
    ...
    at[60] = "comma";
    bt[60] = ",";
    at[61] = "interaction on";
    bt[61] = "\375GQ";
    at[62] = "interaction off";
    bt[62] = "\375Gq";
    at[63] = "stack default datapath";
    bt[63] = "\375Go";
    at[64] = "save default datapath";
    bt[64] = "\375Go";
    at[65] = "stack tempdisk";
    bt[65] = "\375Gh";
    at[66] = "save tempdisk";
    bt[66] = "\375Gh";
    at[67] = "message shadow";
    bt[67] = "\375Gu ";
    at[68] = "save systempath";
    bt[68] = "\375G^";
    at[69] = "stack systempath";
    bt[69] = "\375G^";
    at[70] = "save time";
    bt[70] = "\375G/";
    at[71] = "stack time";
    ...
    at[75] = "next col";
    bt[75] = "\375G@~";
    at[76] = "save survotype";
    bt[76] = "\375G~";
    at[77] = "stack survotype";
    bt[77] = "\375G~";
    at[78] = "save language";
    bt[78] = "\375G\234"; /* £ */
    at[79] = "stack language";
    bt[79] = "\375G\234";
    at[80] = "save survo.apu";
    bt[80] = "\375G\204"; /* ä */
    at[81] = "stack survo.apu";
    bt[81] = "\375G\204";
    at[82] = "save shadowdim";
    bt[82] = "\375GL7\375GL8";
    at[83] = "stack shadowdim";
    bt[83] = "\375GL7\375GL8";
    at[84] = "save user";
    bt[84] = "\375G\224"; /* ö */
    at[85] = "stack user";
    ...
    at[88] = "labels on";
    bt[88] = "\375GLL";
    at[89] = "save survo2.apu";
    bt[89] = "\375G\216"; /* Ä */
    at[90] = "stack survo2.apu";
    bt[90] = "\375G\216";
    at[91] = "waitrec on";
    bt[91] = "\375GLW";
    at[92] = "waitrec off";
    bt[92] = "\375GLw";
    at[93] = "paint on";
    bt[93] = "\375GLP"; /* 17.11.1996 */
    at[94] = "paint off";
    bt[94] = "\375GLp";
    at[95] = "save insertmode";
    bt[95] = "\375GU";
    at[96] = "stack insertmode";
    bt[96] = "\375GU";
    at[97] = "save fieldtype";
    bt[97] = "\375GLF";
    at[98] = "stack fieldtype";
    bt[98] = "\375GLF";
    at[99] = "save dataname";
    bt[99] = "\375GLf";
    at[100] = "stack dataname";
    bt[100] = "\375GLf";
    at[101] = "save os";
    bt[101] = "\375Gk";
    at[102] = "stack os";
    ...
    bt[105] = "\375GLs";
    at[106] = "save winsize";
    bt[106] = "\375GLZ\375GLz";
    at[107] = "stack winsize";
    bt[107] = "\375GLZ\375GLz";
    at[108] = "play sound";
    bt[108] = "\375GTS";
    at[109] = "stack netsurvo";
    bt[109] = "\375GLn";
    at[110] = "stack netpath";
    bt[110] = "\375GLN";
}
...
static void not_found(char *filename) {
    muste_sprintf(sbuf, "\nCannot open sucro file %s!", filename);
    sur_print(sbuf);
    WAIT;
}
...
static char *w_switch(char *rivi, char *s) {
    ...
    *q = EOS;
    ...
    while (1) {
        ...
        q = strchr(p, '@');
        *q = EOS;
        while ((q2 = strchr(p, ' ')) != NULL) {
            *q2 = '_';
        }
        q2 = strchr(p2, '@');
        if (q2 == NULL) {
            sur_print("\nError in switch code!");
            WAIT;
            return (NULL);
        }
        *q2 = EOS;
    ...
    for (i = 0; i < n; ++i) {
        ...
        *nappi = keys[i];
        ...
        if (keys[i] == ' ') {
            ...
            if (keys[i] == 'I') {
                strcpy(nappi, "INS_LINE");
            }
            if (keys[i] == 'v') {
                strcpy(nappi, "DELETE");
            }
            if (keys[i] == 'V') {
                strcpy(nappi, "DEL_LINE");
            }
            if (keys[i] == 'e') {
                strcpy(nappi, "ERASE");
            }
...
static int lg_muunto(char *jump, char *s) {
    if (*jump == 'G') {
        muste_sprintf(s, "goto %s", jump + 1);
    } else if (*jump == 'L') {
        muste_sprintf(s, "load %s", jump + 1);
    } else {
        if_error();
        return (-1);
    }
    ...
    *q = EOS;
    ...
    case 7:
        if (strcmp(jump[0], jump[1]) == 0) {
            ...
            j1 = 2;
            j2 = 0;
        } else if (strcmp(jump[0], jump[2]) == 0) {
            strcpy(vert, "=");
            j1 = 1;
            j2 = 0;
        } else if (strcmp(jump[1], jump[2]) == 0) {
            strcpy(vert, "<");
            j1 = 0;
            j2 = 1;
        } else {
...
static char *w_if(char *rivi, char *s) {
    ...
    *q = EOS;
    ...
    if (*word1 == 'C') {
        ...
        hae_wnimi(atoi(word1), w1);
    }
    if (*w1 == EOS) {
        strcpy(w1, "{}");
    }
    while ((p = strchr(w1, ' ')) != NULL) {
        *p = '_';
    }
    korvaa2_sp(w1);
    if (*word2 == 'C') {
        ...
        hae_wnimi(atoi(word2), w2);
    }
    if (*w2 == EOS) {
        strcpy(w2, "{}");
    }
    while ((p = strchr(w2, ' ')) != NULL) {
        *p = '_';
    }
    korvaa2_sp(w2);
    i = lg_muunto(jump[j1], go);
    ...
    while (1) {
        ...
        case (unsigned char)TUTCODE: // RS CHA '\375'
            ...
            case 'G':
                ...
                ++p;
                if (*p == EOS) {
                    memmove(crivi, p - 2, strlen(p - 2) + 1);
                    return (1);
                }
                if (*p == 'T') {
                    if (!crivin_alku)
                    //  RS 2026-07-02 This crashes, replaced with memmove: { strcpy(crivi,p-2); crivin_alku=1;
                    //  return(1); }
                    {
                        memmove(crivi, p - 2, strlen(p - 2) + 1);
                        crivin_alku = 1;
                    ...
                    case 'X':
                        ...
                        break;
                    case 'L':
                        p = w_gotoload(rivi, p - 2);
                        if (p == NULL) {
                            return (-1);
                        }
                        break;
                    case (unsigned char)TUTCODE:
                        ++p; // RS CHA '\375'
                        if (*p == 'S') {
                            rcat("{end}");
                            ++p;
                    ...
                    case 'W':
                        ...
                        *q = EOS;
                        /* 26.5.1995 */ if (wait_save) {
                            muste_sprintf(x, "{%s}", p);
                        } else {
                            muste_sprintf(x, "{wait %s}", p);
                        }
                        rcat(x);
                        p = q + 1;
                        break;
                ...
                // RS CHA '\375'
                if (*p == 't' && (unsigned char)*(p + 1) == (unsigned char)TUTCODE && *(p + 2) == 'S') {
                    rcat("{end}");
                    p += 3;
                    break;
                }

                if (*p == 't' && (unsigned char)*(p + 1) == (unsigned char)'_' && strcmp(p + 2, "\375S") == 0) {
                    rcat("{repeat}");
                    p += 4;
                    break;
                }
                ...
                if (*p == 'L') {
                    ...
                    } else if (*p == '0') /* 4.9.1993 */
                    {
                        ...
                        switch (*p) {
                        case 'R':
                            muste_sprintf(x, "{ref set %c}", *(p + 1));
                            break;
                        case 'r':
                            muste_sprintf(x, "{ref jump %c}", *(p + 1));
                            break;
                        case 'D':
                            muste_sprintf(x, "{ref del %c}", *(p + 1));
                            break;
                        }
                        ++p;
                ...
                if (*p == '%') {
                    ...
                    if (tut_index) {
                        ...
                        muste_sprintf(x, "{save system %s}", x1);
                    }
                    rcat(x);
                    ++p; /* R */
                    ++p;
            ...
            case '5':
                ...
                {
                    memmove(crivi, p - 1, strlen(p - 1) + 1);
                    crivin_alku = 1;
                    return (1);
                }
                crivin_alku = 0;
                ...
                if (k == 1) {
                    muste_sprintf(x, "{%s}", x3);
                } else {
                    muste_sprintf(x, "{%s%d}", x3, k);
                }
                rcat(x);
                ++p;
                // RS 2026-07-02             strcpy(crivi,p); return(1);
                memmove(crivi, p, strlen(p) + 1);
                return (1);
...
static int kopioi_alku() {
     ...
     */
    strcpy(apunimi, etmpd);
    strcat(apunimi, "SURVO.XXX");
...
static void lopeta_talletus() {
    ...
    muste_fclose(tutor);
    muste_fclose(tutor2);
    muste_fclose(txt_file); // RS CHA fcloseall();
...
static int etsi_end_koodi() {
    ...
    for (j = r1 + r; j <= r2; ++j) {
        edread(x, j);
        if (strstr(x + 1, "{end}") != NULL) {
            return (1);
        }
        if (strstr(x + 1, "{repeat}") != NULL) {
            return (1);
        }
        if (strstr(x + 1, x2) != NULL) {
            return (1);
        }
        if (strstr(x + 1, x3) != NULL) {
            return (1);
        }
    }
    return (-1);
...
static int tutki_wnimet(char *rivi) {
    ...
    while (1) {
        ...
        *q = EOS;
        ...
        ++p;
        muste_strncpy(wnimi[i - 1], p, MAXPITUUS);
        wnimi[i - 1][MAXPITUUS - 1] = EOS;
        if (i > max_indeksi) {
            max_indeksi = i;
        }
        p = q + 2;
...
static int add_label(char *s) {
    ...
    for (i = 0; i < nlab; ++i) {
        if (strcmp(s, tutlab[i]) == 0) {
            muste_sprintf(sbuf, "\nError on line %d: Label %s already in use!", eol - 1, s);
            sur_print(sbuf);
            WAIT;
            return (-1);
        }
    ...
    *swlist = EOS;
    ...
    while (1) {
        ...
        if (k == 0) {
            ...
            muste_sprintf(sbuf, "\nError on line %d: Incomplete switch statement!", eol - 1);
            sur_print(sbuf);
            WAIT;
            return (-1);
        }
        if (strcmp(osa[0], "case") == 0) {
            ...
            i = strlen(osa[1]);
            if (osa[1][i - 1] != ':') {
                muste_sprintf(sbuf, "\nError on line %d: : missing!", eol - 1);
                sur_print(sbuf);
                WAIT;
                return (-1);
            }
            osa[1][i - 1] = EOS;
            while ((p = strchr(osa[1], '_')) != NULL) {
                *p = ' ';
            }
            strcat(rivi, osa[1]);
            strcat(rivi, "@");
...
static int c_prompt(char *rivi, char *x) {
    ...
    k = split(y, osa, 2);
    if (strcmp(osa[0], "default") != 0) {
        muste_sprintf(sbuf, "\nError on line %d: default missing!", eol - 1);
        sur_print(sbuf);
        WAIT;
        return (-1);
    }
    ...
    if (strcmp(osa[0], "length") != 0 || k < 2) {
        muste_sprintf(sbuf, "\nError on line %d: length missing!", eol - 1);
        sur_print(sbuf);
        WAIT;
        return (-1);
    }
    ...
    if (strcmp(osa[0], "wait") != 0 || k < 2) {
        muste_sprintf(sbuf, "\nError on line %d: wait missing!", eol - 1);
        sur_print(sbuf);
        WAIT;
        return (-1);
    }
...
static int c_key(char *rivi, char *x) {
    ...
    *keylist = EOS;
    while (1) {
        ...
        if (muste_strnicmp(osa[1], "ENTER", 5) == 0) {
            keys[i] = CODE_RETURN;
        } else if (muste_strnicmp(osa[1], "RIGHT", 5) == 0) {
            keys[i] = CODE_RIGHT;
        } else if (muste_strnicmp(osa[1], "LEFT", 4) == 0) {
            keys[i] = CODE_LEFT;
        } else if (muste_strnicmp(osa[1], "UP", 2) == 0) {
            keys[i] = CODE_UP;
        } else if (muste_strnicmp(osa[1], "DOWN", 4) == 0) {
            keys[i] = CODE_DOWN;
        } else if (muste_strnicmp(osa[1], "HOME", 4) == 0) {
            keys[i] = CODE_HOME;
        } else if (muste_strnicmp(osa[1], "HELP", 4) == 0) {
            keys[i] = (unsigned char)CODE_HELP;
        } else if (muste_strnicmp(osa[1], "ESC", 3) == 0) {
            keys[i] = (unsigned char)CODE_EXEC;
        } else if (muste_strnicmp(osa[1], "SP", 2) == 0) {
            keys[i] = ' ';
        } else if (muste_strnicmp(osa[1], "COLON", 5) == 0) {
            keys[i] = ':';
        } else if (muste_strnicmp(osa[1], "INSERT", 6) == 0) {
            keys[i] = CODE_INSERT;
        } else if (muste_strnicmp(osa[1], "INS_LINE", 8) == 0) {
            keys[i] = CODE_INSERTL;
        } else if (muste_strnicmp(osa[1], "DELETE", 6) == 0) {
            keys[i] = CODE_DELETE;
        } else if (muste_strnicmp(osa[1], "DEL_LINE", 8) == 0) {
            keys[i] = CODE_DELETEL;
        } else if (muste_strnicmp(osa[1], "ERASE", 5) == 0) {
            keys[i] = CODE_ERASE;
        } else if (muste_strnicmp(osa[1], "NEXT", 4) == 0) {
            keys[i] = CODE_NEXT;
        } else if (muste_strnicmp(osa[1], "PREV", 4) == 0) {
            keys[i] = CODE_PREV;
        } else if (muste_strnicmp(osa[1], "DISK", 4) == 0) {
            keys[i] = (unsigned char)CODE_DISK;
        } else if (muste_strnicmp(osa[1], "BACKSP", 6) == 0) {
            keys[i] = CODE_BACKSP;
        } else if (muste_strnicmp(osa[1], "REF", 3) == 0) {
            keys[i] = (unsigned char)CODE_REF;
        } else if (muste_strnicmp(osa[1], "MERGE", 5) == 0) {
            keys[i] = (unsigned char)CODE_MERGE;
        } else if (muste_strnicmp(osa[1], "COPY", 4) == 0) {
            keys[i] = (unsigned char)CODE_COPY;
        } else if (muste_strnicmp(osa[1], "TAB", 3) == 0) {
            keys[i] = CODE_TAB;
        } else if (muste_strnicmp(osa[1], "HELP", 4) == 0) {
            keys[i] = (unsigned char)CODE_HELP;
        } else if (muste_strnicmp(osa[1], "SRCH", 4) == 0) {
            keys[i] = (unsigned char)CODE_SRCH;
        } else if (muste_strnicmp(osa[1], "ACTIV", 5) == 0) {
            keys[i] = CODE_ACTIV;
        } else if (muste_strnicmp(osa[1], "MOVE", 4) == 0) {
            keys[i] = (unsigned char)CODE_MOVE;
        } else if (muste_strnicmp(osa[1], "END", 3) == 0) {
            keys[i] = (unsigned char)CODE_END;
        } else if (muste_strnicmp(osa[1], "WORDS", 3) == 0) {
            keys[i] = (unsigned char)CODE_WORDS;
...
static int lgmuunto(char *s1, char *s2, char *jump) {
    if (strcmp(s1, "goto") == 0) {
        strcpy(jump, "G");
        add_goto(s2);
    } else if (strcmp(s1, "load") == 0) {
        strcpy(jump, "L");
    } else {
        sur_print("\ngoto or load missing!");
        return (-1);
    }
    strcat(jump, s2);
    return (1);
...
static int c_if2(char *rivi, char *x) {
    ...
    */
    ...
    if (*osa[2] == '\'') {
        return (0); // sivuutetaan ei-num.ehdot
    }
    ...
    *jump[1] = EOS;
    ...
    muste_sprintf(y, "\375GTi|%s|@|%s|@%s@%s@%s@", expr1, expr2, jump[j[0]], jump[j[1]], jump[j[2]]);
    // Rprintf("\ny=%s",y); getch();
    strcat(rivi, y);
...
static int c_if(char *rivi, char *x) {
    ...
    *jump[1] = EOS;
    ...
    muste_sprintf(y, "\375GTI%c%s@%s@%s@%s@%s@", laji, word1, word2, jump[j[0]], jump[j[1]], jump[j[2]]);
    /*  Rprintf("\ny=%s",y); getch(); */
    strcat(rivi, y);
    return (1);
}
...
static int spec_code(char *rivi, char *x) {
    ...
    /* *x='-' */
    {
        ...
        if (strcmp(osa[0], "switch") == 0) {
            i = c_switch(rivi, x);
            return (i);
        }
        if (strcmp(osa[0], "prompt") == 0) {
            i = c_prompt(rivi, x);
            return (i);
        }
        if (strcmp(osa[0], "on") == 0) {
            i = c_key(rivi, x);
            return (i);
        }
        if (strcmp(osa[0], "if") == 0) {
            i = c_if(rivi, x);
            return (i);
        }

        muste_sprintf(sbuf, "\nUnknown control line %d: %s", eol - 1, x);
        sur_print(sbuf);
        WAIT;
        return (-1);
    }
...
static int muunna(char *rivi, char *s) {
    ...
    if (strncmp(s, "error handler ", 14) == 0) {
        ...
        if (*p == 'G') {
            *p = 'g'; /* jotta tut_continue toimisi */
        }
        strcat(rivi, "\375GTE");
        strcat(rivi, p);
        strcat(rivi, "@");
    ...
    if (strncmp(s, "soft ", 5) == 0) /* {soft Wi=Vj} etc. */
    {
        ...
        q = strchr(p, '=');
        if (q == NULL) {
            muste_sprintf(sbuf, "\nError on line %d: = missing in {soft ...}", eol - 1);
            sur_print(sbuf);
            WAIT;
            return (-1);
        }
        *q = EOS;
        ...
        muste_sprintf(sbuf, "\375GTv%s%s@", y, x);
        strcat(rivi, sbuf);
    ...
    *txt_file_name = EOS;
    ...
    if (g > 2) {
        if (!isdigit(*word[2])) {
            ...
            if (!muste_is_path(word[2])) // RS CHA p=strchr(word[2],':'); if (p==NULL && *word[2]!='/' && *word[2]!='\\'
    ...
    *etusukro = EOS;
    ...
    if (p != NULL) {
        *p = EOS;
        ...
        for (i = 0; i < nosat; ++i) {
            if (muste_strcmpi(etusukro, osasukro[i]) == 0) {
                break;
            }
        }
        if (i == nosat) {
            muste_sprintf(sbuf, "\nSucro %s not found in sucro file %s!", etusukro, nimi);
            sur_print(sbuf);
            WAIT;
            return (-1);
        }
    ...
    if (p != NULL) {
        ...
        */
        for (is = 0; is < nosat; ++is) {
            if (muste_strcmpi(etusukro, osasukro[is]) == 0) {
                break;
            }
        }
        if (is == nosat) {
