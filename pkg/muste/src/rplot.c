...
// Actual plotting commands			
		...
		if (strcmp(terms[0],"curve")==0 && i==9) { if (initnewviewport) { muster_initviewport(); 
}muster_curve_plot(plot_id,atof(terms[1]),atof(terms[2]),atof(terms[3]),atof(terms[4]),atof(terms[5]),atof(terms[6]),atof(terms[7]),atof(terms[8])); continue; }
		...
		if (strcmp(terms[0],"arc")==0 && i==7) { if (initnewviewport) { muster_initviewport(); 
}muster_arc_plot(plot_id,atof(terms[1]),atof(terms[2]),atof(terms[3]),atof(terms[4]),atof(terms[5]),atof(terms[6])); continue; }
		...
		if (strcmp(terms[0],"polygon")==0 && i==2) { if (initnewviewport) { muster_initviewport(); 
}muster_polygon_plot(plot_id,terms[1]); continue; }
		}
	...
	*komento=EOS;
	...
	if (i>=0)
		...
		if (i>0)
			...
			if (strcmp(devparm[0],"PDF")==0) { if (i<2) { strcat(defrplotname,"PDF"); 
}muste_sprintf(komento,"pdf(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"POSTSCRIPT")==0) { if (i<2) { strcat(defrplotname,"PS"); 
}muste_sprintf(komento,"postscript(\"%s\",fonts=c(\"mono\"))",devparm[1]); }
			else if (strcmp(devparm[0],"PS")==0) { if (i<2) { strcat(defrplotname,"PS"); 
}muste_sprintf(komento,"postscript(\"%s\",fonts=c(\"mono\"))",devparm[1]); }
			else if (strcmp(devparm[0],"XFIG")==0) { if (i<2) { strcat(defrplotname,"XFIG"); 
}muste_sprintf(komento,"xfig(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"BITMAP")==0) { if (i<2) { strcat(defrplotname,"BMP"); 
}muste_sprintf(komento,"bitmap(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"PICTEX")==0) { if (i<2) { strcat(defrplotname,"PICTEX"); 
}muste_sprintf(komento,"pictex(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"X11")==0) { if (i<2) { strcat(defrplotname,"X11"); 
}muste_sprintf(komento,"X11(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"CAIRO_PDF")==0) { if (i<2) { strcat(defrplotname,"PDF"); 
}muste_sprintf(komento,"cairo_pdf(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"CAIRO_PS")==0) { if (i<2) { strcat(defrplotname,"PS"); 
}muste_sprintf(komento,"cairo_ps(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"SVG")==0) { if (i<2) { strcat(defrplotname,"SVG"); 
}muste_sprintf(komento,"svg(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"PNG")==0) { if (i<2) { strcat(defrplotname,"PNG"); 
}muste_sprintf(komento,"png(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"JPEG")==0) { if (i<2) { strcat(defrplotname,"JPEG"); 
}muste_sprintf(komento,"jpeg(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"JPG")==0) { if (i<2) { strcat(defrplotname,"JPG"); 
}muste_sprintf(komento,"jpg(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"BMP")==0) { if (i<2) { strcat(defrplotname,"BMP"); 
}muste_sprintf(komento,"bmp(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"TIFF")==0) { if (i<2) { strcat(defrplotname,"TIFF"); 
}muste_sprintf(komento,"tiff(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"TIF")==0) { if (i<2) { strcat(defrplotname,"TIF"); 
}muste_sprintf(komento,"tif(\"%s\")",devparm[1]); }
			else if (strcmp(devparm[0],"QUARTZ")==0) { if (i<2) { strcat(defrplotname,"QUARTZ"); 
}muste_sprintf(komento,"quartz(\"%s\")",devparm[1]); } // Mac OS X only
			else if (strcmp(devparm[0],"METAFILE")==0) { if (i<2) { strcat(defrplotname,"WMF"); 
}muste_sprintf(komento,"win.metafile(\"%s\")",devparm[1]); } // Win only
			else if (strcmp(devparm[0],"EMF")==0) { if (i<2) { strcat(defrplotname,"EMF"); 
}muste_sprintf(komento,"metafile(\"%s\")",devparm[1]); } // Win only
			else if (strcmp(devparm[0],"WMF")==0) { if (i<2) { strcat(defrplotname,"WMF"); 
}muste_sprintf(komento,"metafile(\"%s\")",devparm[1]); } // Win only
			else if (strcmp(devparm[0],"WIN.METAFILE")==0) { if (i<2) { strcat(defrplotname,"WMF"); 
}muste_sprintf(komento,"win.metafile(\"%s\")",devparm[1]); } // Win only
			else if (strcmp(devparm[0],"WIN.PRINT")==0) { if (i<2) { strcat(defrplotname,"WIN"); 
}muste_sprintf(komento,"win.print(\"%s\")",devparm[1]); } // Win only
