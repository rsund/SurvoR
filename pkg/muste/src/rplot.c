...
static int muster_curve_plot(int id, double x1, double y1, double x2, double y2, double cx1, double cy1, double cx2,
                             double cy2);
...
int muste_rplot(char *argv) {
    ...
    if (g > 2 && strcmp(word[g - 2], "TO") == 0) {
        strcpy(outfilename, word[g - 1]);
        i = 1;
    }
    ...
    while (1) {
        ...
        if (strcmp(terms[0], "charcolor") == 0 && i == 2) {
            muste_fieldcopy(charcolor, terms[1], 8);
            continue;
        }
        if (strcmp(terms[0], "pencolor") == 0 && i == 2) {
            muste_fieldcopy(pencolor, terms[1], 8);
            fillcolor = pencolor;
            continue;
        }
        if (strcmp(terms[0], "linecolor") == 0 && i == 2) {
            muste_fieldcopy(linecolor, terms[1], 8);
            continue;
        }
        if (strcmp(terms[0], "linestyle") == 0 && i == 3) {
            linetype = atoi(terms[1]);
            linewidth = atoi(terms[2]);
            continue;
        }
        if (strcmp(terms[0], "background") == 0 && i == 2) {
            muste_fieldcopy(background, terms[1], 8);
            continue;
        }
        ...
        if (strcmp(terms[0], "font") == 0 && i == 5) {
            ...
            if (strcmp(terms[3], "italic") == 0) {
                fontface = 3;
            } else {
                fontface = 1;
            }
            if (strcmp(terms[2], "bold") == 0) {
                fontface++;
            }

            if (strcmp(terms[4], "Courier") == 0) {
                strcpy(fontfamily, "mono");
            } else if (strcmp(terms[4], "Mono") == 0) {
                strcpy(fontfamily, "mono");
            } else if (strcmp(terms[4], "Helvetica") == 0) {
                strcpy(fontfamily, "HersheySans");
            } else if (strcmp(terms[4], "Swiss") == 0) {
                strcpy(fontfamily, "HersheySans");
            } else if (strcmp(terms[4], "Arial") == 0) {
                strcpy(fontfamily, "HersheySerif");
            } else if (strcmp(terms[4], "Times") == 0) {
                strcpy(fontfamily, "HersheySerif");
            } else {
                muste_fieldcopy(fontfamily, terms[4], 255);
            }
            if (debug) {
                Rprintf("\nfont out");
            }
        ...
        if (strcmp(terms[0], "curve") == 0 && i == 9) {
            ...
            muster_curve_plot(plot_id, atof(terms[1]), atof(terms[2]), atof(terms[3]), atof(terms[4]), atof(terms[5]),
        ...
        if (strcmp(terms[0], "arc") == 0 && i == 7) {
            ...
            muster_arc_plot(plot_id, atof(terms[1]), atof(terms[2]), atof(terms[3]), atof(terms[4]), atof(terms[5]),
                            atof(terms[6]));
            continue;
        }
        ...
        if (strcmp(terms[0], "polygon") == 0 && i == 2) {
            ...
            muster_polygon_plot(plot_id, terms[1]);
            continue;
        }
    }
    ...
    *komento = EOS;
    ...
    if (i >= 0) {
        ...
        if (i > 0) {
            ...
            if (strcmp(devparm[0], "PDF") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PDF");
                }
                muste_sprintf(komento, "pdf(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "POSTSCRIPT") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PS");
                }
                muste_sprintf(komento, "postscript(\"%s\",fonts=c(\"mono\"))", devparm[1]);
            } else if (strcmp(devparm[0], "PS") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PS");
                }
                muste_sprintf(komento, "postscript(\"%s\",fonts=c(\"mono\"))", devparm[1]);
            } else if (strcmp(devparm[0], "XFIG") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "XFIG");
                }
                muste_sprintf(komento, "xfig(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "BITMAP") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "BMP");
                }
                muste_sprintf(komento, "bitmap(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "PICTEX") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PICTEX");
                }
                muste_sprintf(komento, "pictex(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "X11") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "X11");
                }
                muste_sprintf(komento, "X11(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "CAIRO_PDF") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PDF");
                }
                muste_sprintf(komento, "cairo_pdf(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "CAIRO_PS") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PS");
                }
                muste_sprintf(komento, "cairo_ps(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "SVG") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "SVG");
                }
                muste_sprintf(komento, "svg(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "PNG") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "PNG");
                }
                muste_sprintf(komento, "png(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "JPEG") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "JPEG");
                }
                muste_sprintf(komento, "jpeg(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "JPG") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "JPG");
                }
                muste_sprintf(komento, "jpg(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "BMP") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "BMP");
                }
                muste_sprintf(komento, "bmp(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "TIFF") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "TIFF");
                }
                muste_sprintf(komento, "tiff(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "TIF") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "TIF");
                }
                muste_sprintf(komento, "tif(\"%s\")", devparm[1]);
            } else if (strcmp(devparm[0], "QUARTZ") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "QUARTZ");
                }
                muste_sprintf(komento, "quartz(\"%s\")", devparm[1]);
            } // Mac OS X only
            else if (strcmp(devparm[0], "METAFILE") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "WMF");
                }
                muste_sprintf(komento, "win.metafile(\"%s\")", devparm[1]);
            } // Win only
            else if (strcmp(devparm[0], "EMF") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "EMF");
                }
                muste_sprintf(komento, "metafile(\"%s\")", devparm[1]);
            } // Win only
            else if (strcmp(devparm[0], "WMF") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "WMF");
                }
                muste_sprintf(komento, "metafile(\"%s\")", devparm[1]);
            } // Win only
            else if (strcmp(devparm[0], "WIN.METAFILE") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "WMF");
                }
                muste_sprintf(komento, "win.metafile(\"%s\")", devparm[1]);
            } // Win only
            else if (strcmp(devparm[0], "WIN.PRINT") == 0) {
                if (i < 2) {
                    strcat(defrplotname, "WIN");
                }
                muste_sprintf(komento, "win.print(\"%s\")", devparm[1]);
            } // Win only
            else if (strcmp(devparm[0], "SCREEN") == 0 || strncmp(devparm[0], "G", 1) == 0 ||
                     strncmp(devparm[0], "R", 1) == 0) {
                device = 0;
                show_rpicture = 1;
            } else {
                sur_print("\nError with DEVICE!");
    ...
    if (show_rpicture || device == 1) {
        ...
        muste_sprintf(abuf, ".muste.runsource(\"%s\",echo=FALSE,print.eval=FALSE,encoding=\"UTF-8\")",
                      outfilename); // RS 13.2.2014 encoding
        muste_evalr(abuf);
        muste_sleep(300);
        if (device == 1) {
...
static int muster_line_plot(double x1, double y1, double x2, double y2) {
    ...
    case 0:
        ...
        break;
    case 1:
        strcat(komento, ",lty=\"73\")");
        break; // long dash
    case 2:
        strcat(komento, ",lty=\"13\")");
        break; // dotted
    case 3:
        strcat(komento, ",lty=\"4314\")");
        break; // dash dotted
    case 4:
        strcat(komento, ",lty=\"44\")");
        break; // medium dash
    case 5:
        strcat(komento, ",lty=\"431313\")");
        break; // dash with two dots
    case 6:
        strcat(komento, ",lty=\"22\")");
        break; // short dash
    case 7:
        strcat(komento, ",lty=\"43131313\")");
        break; // dash with three dots
    case 8:
        strcat(komento, ",lineend=\"square\")");
        break;
    }
...
static int muster_rectangle_plot(double x1, double y1, double x2, double y2) {
    ...
    muste_sprintf(komento,
                  "grid.rect(x=%g,y=%g,width=%g,height=%g,just=c(\"left\",\"top\")\n,gp=gpar(col=\"%s\",fill=\"%s\"))",
                  x1 / xsize, 1 - y1 / ysize, lev, kork, pencolor, fillcolor);
    fprintf(r_outfile, "%s\n", komento);
    if (debug) {
        Rprintf("\nrectangle out");
    }
...
static int muster_ellipse_plot(double x1, double y1, double x2, double y2) {
    ...
    */
    ...
    muste_sprintf(komento, "grid.circle(%g,%g,r=%g,gp=gpar(col=\"%s\",fill=\"%s\"))", ((x1 + x2) / 2) / xsize,
                  1 - ((y1 + y2) / 2) / ysize, fabs((x1 - x2) / xsize / 2), pencolor, fillcolor);
    fprintf(r_outfile, "%s\n", komento);
    if (debug) {
        Rprintf("\nellipse out");
    }
...
static int muster_arc_plot(int id, double x1, double y1, double x2, double y2, double a1, double a2) {
    ...
    muste_sprintf(komento, "a<-arc(%g,%g,%g,%g,%g)", ((x1 + x2) / 2) / xsize, 1 - ((y1 + y2) / 2) / ysize,
                  fabs((x1 - x2) / xsize / 2), a1 * PII / 180, (a1 + a2) * PII / 180);
    fprintf(r_outfile, "%s\n", komento);
...
static int muster_text_plot(double x1, double y1, char *x) {
    ...
    for (i = 0; i < strlen(x); i++) {
        if ((unsigned char)x[i] > 31) // RS Handle only printable characters
        {
            ...
            if ((unsigned char)x[i] > 127) // RS 18.6.2014
            {
                ...
                y[dest++] = cp858_to_unicode[(unsigned char)x[i] - 128][1];
                y[dest++] = cp858_to_unicode[(unsigned char)x[i] - 128][2];
                y[dest++] = cp858_to_unicode[(unsigned char)x[i] - 128][3];
                y[dest++] = cp858_to_unicode[(unsigned char)x[i] - 128][4];
                y[dest++] = cp858_to_unicode[(unsigned char)x[i] - 128][5];
            } else {
                y[dest++] = x[i];
            }
        } else {
    ...
    muste_sprintf(komento,
                  "grid.text(\"%s\",x=%g,y=%g\n,just=c(\"left\",\"top\"),gp=gpar(col=\"%s\",fontface=%d,fontsize=%d,"
                  "fontfamily=\"%s\"))",
                  y, x1 / xsize, 1 - y1 / ysize, charcolor, fontface, fontsize, fontfamily);
    fprintf(r_outfile, "%s\n", komento);
    if (debug) {
        Rprintf("\ntext out");
    }
