...
extern int muste_curve_plot(int id, double x1, double y1, double x2, double y2, double cx1, double cy1, double cx2,
                            double cy2);
...
extern int fi_create(char *filename, int filen, int fim1, int fim, long fin, int fil, int fiextra, int fitextn,
                     int fitextlen, char *fitext[], char *varname[], int varlen[], char *vartype[]);
...
extern int matrix_load(char *matr, double **A, int *rdim, int *cdim, char **rlab, char **clab, int *lr, int *lc,
                       int *type, char *expr);
extern int matrix_save(char *matr, double *A, int m, int n, char *rlab, char *clab, int mrl, int mcl, int type,
                       char *expr, int nrem, int remrivi);
...
extern int matrix_print2(double *A, int m, int n, char *rlab, char *clab, int lr, int lc, int m2, int n2, int *mv,
                         int *nv, char *form, int width, int editline, char *outfile, char *header, int nlimit,
                         double *limit, char *shadow, char **c_form, int *p_one);
