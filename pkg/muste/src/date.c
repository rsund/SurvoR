...
static struct tm *julcd(Julian jd) { return julcdj(jd, jul_transition); }
...
static int check_parameters(void) {
    ...
    if (suomi) {
        return -1; /* ei data-moodia suomeksi! */
    }
    return 2; /* data mode */
}
...
static int check_date(void) {
    ...
    if (g < 2) { /* no parameter given */
        if (suomi) {
            strcpy(command_line, "PVM");
        } else {
            strcpy(command_line, "DATE");
        }
        time(&tnow);
        D = localtime(&tnow);
    ...
    if (suomi) {
        muste_sprintf(command_line, "PVM %s", word[1]);
    } else {
        muste_sprintf(command_line, "DATE %s", word[1]);
    }
    return 1; /* editorial mode */
}

static void no_mem(void) { muste_kv_s_err("Not enough memory! (%s)", word[0]); }
...
static char *vuosi[] = { // 22.6.2011: ä(ascii:8)=204
    "tammikuu",    "helmikuu", "maaliskuu", "huhtikuu", "toukokuu",  "kes\204kuu",
    "hein\204kuu", "elokuu",   "syyskuu",   "lokakuu",  "marraskuu", "joulukuu"};
static char *year[] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
...
static int recheck_date(int index) {
    ...
    if (aYear > 199) {
        aYear -= 1900; /* tm_year:n suhdeluku */
    }
...
static int check_format(char *format) {
    ...
    if (!strcmp(format, "DDYYMM")) {
        return 22;
    }
    if (!strcmp(format, "MMDDYY")) {
        return 23;
    }
    if (!strcmp(format, "MMYYDD")) {
        return 24;
    }
    if (!strcmp(format, "YYDDMM")) {
        return 25;
    }
    if (!strcmp(format, "YYMMDD")) {
        return 26;
    }
    if (!strcmp(format, "DDMMMYY")) {
        return 27;
    }
    if (!strcmp(format, "DDYYMMM")) {
        return 28;
    }
    if (!strcmp(format, "MMMDDYY")) {
        return 29;
    }
    if (!strcmp(format, "MMMYYDD")) {
        return 30;
    }
    if (!strcmp(format, "YYDDMMM")) {
        return 31;
    }
    if (!strcmp(format, "YYMMMDD")) {
        return 32;
    }
    if (!strcmp(format, "DDMMYYYY")) {
        return 33;
    }
    if (!strcmp(format, "DDYYYYMM")) {
        return 34;
    }
    if (!strcmp(format, "MMDDYYYY")) {
        return 35;
    }
    if (!strcmp(format, "MMYYYYDD")) {
        return 36;
    }
    if (!strcmp(format, "YYYYDDMM")) {
        return 37;
    }
    if (!strcmp(format, "YYYYMMDD")) {
        return 38;
    }
    if (!strcmp(format, "DDMMMYYYY")) {
        return 39;
    }
    if (!strcmp(format, "DDYYYYMMM")) {
        return 40;
    }
    if (!strcmp(format, "MMMDDYYYY")) {
        return 41;
    }
    if (!strcmp(format, "MMMYYYYDD")) {
        return 42;
    }
    if (!strcmp(format, "YYYYDDMMM")) {
        return 43;
    }
    if (!strcmp(format, "YYYYMMMDD")) {
        return 44;
    }
    ...
    if (!strcmp(format, "MMM")) {
        return 64;
    }
    if (!strcmp(format, "YYYY")) {
        return 65;
    }
    if (!strcmp(format, "DDMM")) {
        return 66;
    }
    if (!strcmp(format, "DDYY")) {
        return 67;
    }
    if (!strcmp(format, "MMDD")) {
        return 68;
    }
    if (!strcmp(format, "MMYY")) {
        return 69;
    }
    if (!strcmp(format, "YYDD")) {
        return 70;
    }
    if (!strcmp(format, "YYMM")) {
        return 71;
    }
    if (!strcmp(format, "DDMMM")) {
        return 72;
    }
    if (!strcmp(format, "MMMDD")) {
        return 73;
    }
    if (!strcmp(format, "MMMYY")) {
        return 74;
    }
    if (!strcmp(format, "YYMMM")) {
        return 75;
    }
    if (!strcmp(format, "DDYYYY")) {
        return 76;
    }
    if (!strcmp(format, "MMYYYY")) {
        return 77;
    }
    if (!strcmp(format, "YYYYDD")) {
        return 78;
    }
    if (!strcmp(format, "YYYYMM")) {
        return 79;
    }
    if (!strcmp(format, "MMMYYYY")) {
        return 80;
    }
    if (!strcmp(format, "YYYYMMM")) {
        return 81;
    }
...
static int write_format(int i, char *format, char *del1, char *del2) {
    ...
    case 21:
        muste_sprintf(format, "%%d%s%%m%s%%y", del1, del2);
        break;
    case 22:
        muste_sprintf(format, "%%d%s%%y%s%%m", del1, del2);
        break;
    case 23:
        muste_sprintf(format, "%%m%s%%d%s%%y", del1, del2);
        break;
    case 24:
        muste_sprintf(format, "%%m%s%%y%s%%d", del1, del2);
        break;
    case 25:
        muste_sprintf(format, "%%y%s%%d%s%%m", del1, del2);
        break;
    case 26:
        muste_sprintf(format, "%%y%s%%m%s%%d", del1, del2);
        break;
    case 27:
        muste_sprintf(format, "%%d%s%%b%s%%y", del1, del2);
        break;
    case 28:
        muste_sprintf(format, "%%d%s%%y%s%%b", del1, del2);
        break;
    case 29:
        muste_sprintf(format, "%%b%s%%d%s%%y", del1, del2);
        break;
    case 30:
        muste_sprintf(format, "%%b%s%%y%s%%d", del1, del2);
        break;
    case 31:
        muste_sprintf(format, "%%y%s%%d%s%%b", del1, del2);
        break;
    case 32:
        muste_sprintf(format, "%%y%s%%b%s%%d", del1, del2);
        break;
    case 33:
        muste_sprintf(format, "%%d%s%%m%s%%Y", del1, del2);
        break;
    ...
    case 61:
        muste_sprintf(format, "%%d");
        break;
    case 62:
        muste_sprintf(format, "%%m");
        break;
    case 63:
        muste_sprintf(format, "%%y");
        break;
    case 64:
        muste_sprintf(format, "%%b");
        break;
    case 65:
        muste_sprintf(format, "%%Y");
        break;
    ...
    case 66:
        muste_sprintf(format, "%%d%s%%m", del1);
        break;
    case 67:
        muste_sprintf(format, "%%d%s%%y", del1);
        break;
    case 68:
        muste_sprintf(format, "%%m%s%%d", del1);
        break;
    case 69:
        muste_sprintf(format, "%%m%s%%y", del1);
        break;
    case 70:
        muste_sprintf(format, "%%y%s%%d", del1);
        break;
    case 71:
        muste_sprintf(format, "%%y%s%%m", del1);
        break;
    case 72:
        muste_sprintf(format, "%%d%s%%b", del1);
        break;
    case 73:
        muste_sprintf(format, "%%b%s%%d", del1);
        break;
    case 74:
        muste_sprintf(format, "%%b%s%%y", del1);
        break;
    case 75:
        muste_sprintf(format, "%%y%s%%b", del1);
        break;
    case 76:
        muste_sprintf(format, "%%d%s%%Y", del1);
        break;
...
static int check_specifications(void) {
    ...
    if (j >= 0) {
        ...
        if (iDid > 60) {
            muste_kv_s_err("Partial date formats (like %s) are for ODATE only!", indate_format);
            return -1;
        }
        /* IDEL */
        delch1 = EOS;
        ...
        muste_sprintf(idel1, "%c", delch1);
        muste_sprintf(idel2, "%c", delch2);
        idellen = strlen(idel1) + strlen(idel2); /* 0,1,2 */
        iDLen = strlen(indate_format);
        if (iDid > 20) {
            iDLen += idellen;
        }
    ...
    if (j >= 0) {
        ...
        muste_sprintf(odel1, "%c", delch1);
        muste_sprintf(odel2, "%c", delch2);
        odellen = strlen(odel1) + strlen(odel2); /* 0,1,2 */
        oDLen = strlen(outdate_format);
        if (oDid > 20) {
            oDLen += odellen;
        }
    ...
    if (j >= 0) {
        ...
        case 2000:
            break;
        default:
            muste_kv_s_err("Allowed values for CENTURY are 1900 and 2000!");
            return -1;
        }
    }
...
static int check_activations(void) {
    ...
    if ((julday >= 0) || (ivar >= 0)) { /* 21.2.2009 (!) */
        ...
        if (day0 < 1794108L || day0 > 5373482L) {
            day0 = 0L;
        }
...
static int check_vartype(int vix,   /* vix = variable index               */
                         ...
                         char *nam) /* nam = description of variable      */
{
    ...
    if (vix < 0) {
        return 1; /* variable not found this time */
    }
    ...
    case 'S':
        if (dat.vartype[vix][0] != 'S') {
            some_err = 1;
            muste_kv_s_err("The '%c' variable (%s) requires type S!", msk, nam);
        } else { /* 'S' */
            if (!(dat.varlen[vix] >= rle)) {
                some_err = 1;
                muste_kv_s_err("The '%c' variable (%s) must be at least %d bytes!", msk, nam, rle);
            }
        }
        break;
    case 'N':
        if (dat.vartype[vix][0] != 'S') {
            ...
            if (dat.varlen[vix] < mle) {
                some_err = 1;
                muste_kv_s_err("The '%c' variable (%s) must be at least %d bytes!", msk, nam, mle);
            }
        }
        break;
    }
...
static int check_input_output(void) {
    ...
    if (Dvars == 0) { /* old D,M,Y method */
        ...
        if (newdate < 0 && weekday < 0 && dayofyear < 0 && weekofyear < 0 && julday < 0) {
...
static void data_dates(void) {
    ...
    i = data_open2(word[1], &dat, 1, 0, 0);
    if (i < 0) {
        return;
    }
    i = conditions(&dat);
    if (i < 0) {
        return; // moved here 11.2.2005 (!) to cover diff's
    }
    i = check_specifications();
    if (i < 0) {
        return;
    }
...
static int count_date_rules(void) {
    ...
    while (1) {
        ...
        edread(rule, i);
        p = rule + 1;
        if ((!strcmp(p, space)) || (!strncmp(p, "END", 3))) {
            break;
        }
        rules++;
    }
...
static void apply_date_rules(void) {
    ...
    for (l = dat.l1; l <= dat.l2; l++) {
        ...
        time(&tnow);
        D = localtime(&tnow); /* siirretty loopin sisään */
        if (prind) {
            muste_kv_s_disp("%d ", l);
        }
        ...
        for (i = 0; i < rules; i++) {
            ...
            if (valid_date(pv1, kk1, vv1)) {
                if (vv1 < 100) { /* properly not until 26.2.2001 :( */
                    if (shift) {
                        if (vv1 < shift) {
                            vv1 += 100; /*   YY: shifting if necessary */
                        }
                    } else {
                ...
                if (vv1 > 199) {
                    vv1 -= 1900; /* YYYY: scaling for reference */
                }
                D->tm_year = vv1;
                D->tm_mon = kk1 - 1;
                D->tm_mday = pv1;
            ...
            if (valid_date(pv2, kk2, vv2)) {
                if (vv2 < 100) { /* properly not until 26.2.2001 :( */
                    if (shift) {
                        if (vv2 < shift) {
                            vv2 += 100; /*   YY: shifting if necessary */
                        }
                    } else {
                ...
                if (vv2 > 199) {
                    vv2 -= 1900; /* YYYY: scaling for reference */
                }
                D->tm_year = vv2;
                D->tm_mon = kk2 - 1;
                D->tm_mday = pv2;
            ...
            if (Jday1 && Jday2) {
                ...
                if (dat.vartype[dd[i]][0] == 'S') {
                    ...
                    data_save(&dat, l, dd[i], atof(sbuf));
                }
            } else {
    ...
    if (bad && etu == 0) { /* 2.1.1998 */
        muste_kv_s_err("%d date%scould not be processed!", bad, (bad > 1) ? "s " : " ");
    }
}
        ...
        while (1) {
            ...
            if (valid_date(pv, kk, vv)) {
                if (vv < 100) { /* properly not until 26.2.2001 :( */
                    if (shift) {
                        if (vv < shift) {
                            vv += 100; /*   YY: shifting if necessary */
                        }
                    } else {
                ...
                if (vv > 199) {
                    vv -= 1900; /* YYYY: scaling for reference */
                }
                D->tm_year = vv;
                D->tm_mon = kk - 1;
                D->tm_mday = pv;
...
static int scan_values(int var, int obs, int *pv, int *kk, int *vv, int *hh, int *mm, int *ss) {
    ...
    *vv = -1; /* initial values! */
    ...
    if (idellen) { /* delimited dates */
        ...
        if (len != iDLen) {
            return -1; /* required for non-delimited! */
        }
        switch (iDid) {
        case 21: /* DDMMYY      */
        case 33: /* DDMMYYYY    */
    ...
    if (itime) { /* myöhemmin järjestettävä paremmin */
        ...
        *hh = atoi(++p);
        while (*p != '\0' && *p != ':') {
            p++; /* toistaiseksi vain muoto HH:MM:SS */
        }
        *mm = atoi(++p);
        while (*p != '\0' && *p != ':') {
            p++;
...
static int montoi(char *mon) {
    if (!muste_strnicmp(mon, "Jan", 3)) {
        return 1;
    } else if (!muste_strnicmp(mon, "Feb", 3)) {
        return 2;
    } else if (!muste_strnicmp(mon, "Mar", 3)) {
        return 3;
    } else if (!muste_strnicmp(mon, "Apr", 3)) {
        return 4;
    } else if (!muste_strnicmp(mon, "May", 3)) {
        return 5;
    } else if (!muste_strnicmp(mon, "Jun", 3)) {
        return 6;
    } else if (!muste_strnicmp(mon, "Jul", 3)) {
        return 7;
    } else if (!muste_strnicmp(mon, "Aug", 3)) {
        return 8;
    } else if (!muste_strnicmp(mon, "Sep", 3)) {
        return 9;
    } else if (!muste_strnicmp(mon, "Oct", 3)) {
        return 10;
    } else if (!muste_strnicmp(mon, "Nov", 3)) {
        return 11;
    } else if (!muste_strnicmp(mon, "Dec", 3)) {
        return 12;
    }
    return 0; /* */
}
...
static void write_values(int obs) {
    if (newdate >= 0) { /* mask 'd' */
        ...
        if (Dvars && oDLen) { /* 16.11.1999 */
            ...
            if (Dvars > 1) {
                return; /* no other things at the same time */
            }
        }
    }
    ...
    if (dayofyear >= 0) {
        ...
        if (dat.vartype[dayofyear][0] == 'S') {
            ...
            data_save(&dat, obs, dayofyear, atof(sbuf));
        }
    }
    ...
    if (weekofyear >= 0) {
        ...
        if (dat.vartype[weekofyear][0] == 'S') {
            ...
            data_save(&dat, obs, weekofyear, atof(sbuf));
        }
    }
    ...
    if (julday >= 0) { /* 12.2.1998 */
        ...
        if (dat.vartype[julday][0] == 'S') {
            ...
            data_save(&dat, obs, julday, atof(sbuf));
        }
    }
}
...
void muste_date(char *argv) {
    ...
    if (!muste_strcmpi(word[0], "PVM")) {
        suomi = 1; /* PVM-komento 11.12.2000 (SM:n ehdotus) */
    }
    i = check_parameters();
    switch (i) {
    case 1:
