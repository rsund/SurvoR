...
# Some R functions for Muste Desktop operations by KV 20.6.2011 (3.8.2011)
...
.muste.desktop.fileinfo.SEARCH <- function(filespec)
{
  .muste.tmp.filespec    <<- filespec
...
.muste.desktop.fileinfo.SEARCH.cleanup <- function()
{
  remove(.muste.tmp.filespec  , envir=.GlobalEnv)
