...
// matrix_file0() ei ilmeisesti Musteen kirjastossa

static int mat_name(matfile,matr)
char *matfile;
char *matr;
        {
        *matfile=EOS;
...
#if 0
static FILE *MAT;
static int matrix_save0(char *matr,double *A,int m,int n,char *rlab,char *clab,int mrl,int mcl,int type,char *expr,int nrem,int remrivi,char *ptext)
